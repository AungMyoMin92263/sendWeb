...
const WebEcommerceShop = (props: any) => {
                    ...
                    <div className={`${mainStyles.flex} ${mainStyles.cat_bg}`}>
                        ...
                        <div className={`${mainStyles.wrapper_right_cat}`}>
                            <div className={`${mainStyles.commerce_right_cat} ${mainStyles.flex} ${styles.p_15}`}>
                                ...
                                <div className={mainStyles.shop_div}>
                                    <img src={Shop} alt="Shop" className={`${mainStyles.shop_ImageStyle}`} />
                                </div>
                                <div className={styles.ml_30}>
                                    <Typography className={styles.send_typography}
                                        variant="subtitle1"
                                        component="div"
                                        sx={{ flexGrow: 1, mb: 2, fontWeight: 'bold' }}
                                    >
                                        Minny Row Market
                                    </Typography>
                                    <div className={`${mainStyles.mb_8} ${mainStyles.flex} `}>
                                        <AccessTimeFilledIcon sx={{ fontSize: 16, mr: 0.5 }}></AccessTimeFilledIcon>
                                        <Typography className={styles.send_typography} pr={2} gutterBottom sx={{ fontSize: 12 }} component="div">{props.duration}15 mins </Typography>
                                        <PedalBikeIcon sx={{ fontSize: 16, mr: 0.5 }}></PedalBikeIcon>
                                        <Typography className={styles.send_typography} pr={2} gutterBottom sx={{ fontSize: 12 }} component="div">{props.delievery} 1.5 km</Typography>
                                    </div>
                                    <div className={mainStyles.shop_label_div}>
                                        <LocalOfferIcon sx={{ fontSize: 14, mr: 0.5 }}></LocalOfferIcon><span>S$10.00 off delivery fee</span>
                                    </div>
                                    <div className={mainStyles.shop_label_div}>
                                        <LocalOfferIcon sx={{ fontSize: 14, mr: 0.5 }}></LocalOfferIcon><span>S$10.00 off delivery fee</span>
                                    </div>
                                ...
                                <div className={styles.ml_30}>
                                    <div className={`${mainStyles.mt_45}`}><span>Products</span><span
                                        className={`${styles.ml_16} ${styles.primary_color}`}>115</span></div>
                                    <div className={`${mainStyles.mt_8}`}><span>Rating</span><span className={`${styles.ml_16} ${styles.primary_color}`}>
                                        <StarIcon sx={{ fontSize: 16 }}></StarIcon>
                                        4.9</span></div>
                                    <div className={`${mainStyles.mt_8}`}><span>Address</span><span className={`${styles.ml_16} ${styles.primary_color}`}>234, Merchant street</span></div>
                                </div>
                            </div>
                            ...
                            <div className={`${mainStyles.product_row_div_cat}`}>
                                <Typography className={styles.send_typography}
                                    ...
                                    align="left"
                                >
                                    Minny Row Market | <span className={`${styles.primary_color} ${styles.f_24}`}>Fruits</span>
                                </Typography>
                                <div style={{ width: "100%" }}>
                                    <div style={{ width: "100%" }}>
                                        <Box
